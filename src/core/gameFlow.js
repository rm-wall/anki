...
import { calculateEditDistance, highlightAnswerDifferences, shuffle } from '../utils/algorithms.js';
...
export function createGameFlow(state, elements, cardManager, translations) {
    ...
    async function startSession(cards) {
        ...
        const requiredStreakSetting = parseInt(elements.requiredStreakInput.value, 10) || 2;
